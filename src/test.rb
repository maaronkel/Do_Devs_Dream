...
class StartTest
  questions = [
    ...
    ["Describe in single words only the good things that come to mind about your mother.", "Love, warm voice, cookies", "Eat. Your. Vegetables", "..."],
    ...
    ["A friend offers you tequila. In the glass lies a worm. Time to...", "Drink it and enjoy the ritual", "Why would a worm be in my glass?", "Say 'No thanks, I'm the designated driver'"],
    ["Now and then you contemplate life alone. It is...", "Charming", "Boring", "Intriguing"],
    ["At a party, a guest boasts of their perfect life. How do you respond?", "I try to outdo them", "I mock them", "I sit silently"],
    ["You're reading a magazine. You come across a full-page nude photo of a girl or guy. You show it to your partner, who likes it so much, they hang it on your bedroom wall. The girl/guy is lying on a bearskin rug.", "I wouldn't allow that", "I would take it down", "Huh?"],
    ["It is 'Bring Your Kids to Work Day'. Your child misbehaves, and is slapped by the boss. What is your reaction?", "Horror", "About time", "Jealousy"],
